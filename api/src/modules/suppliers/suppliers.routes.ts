...
export async function registerSupplierRoutes(
  ...
  async function handleListSuppliers(
    ...
    const result = await listSuppliers(request.db, query);
  ...
  async function handleCreateSupplier(
    ...
    const supplier = await createSupplier(request.db, input);
  ...
  async function handleGetSupplier(
    ...
    const profile = await getSupplierProfile(request.db, params.id);
  ...
  async function handleUpdateSupplier(
    ...
    const supplier = await updateSupplier(request.db, params.id, input);
