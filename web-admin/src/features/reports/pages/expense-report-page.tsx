          ...
          <>
            <div className="summary-grid">
              <article className="summary-card">
                <span>Expenses</span>
                <strong>PKR {trimDecimalZeros(report.totals.expenseAmount)}</strong>
              </article>
              <article className="summary-card">
                <span>Reversals</span>
                <strong>PKR {trimDecimalZeros(report.totals.reversalAmount)}</strong>
              </article>
              <article className="summary-card">
                <span>Net expenses</span>
                <strong>PKR {trimDecimalZeros(report.totals.netExpenseAmount)}</strong>
              </article>
            </div>
