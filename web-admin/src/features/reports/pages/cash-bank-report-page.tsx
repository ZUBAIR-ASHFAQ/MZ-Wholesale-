              ...
              <section className="management-card" key={`${account.accountType}-${account.accountId}`}>
                ...
                <div className="summary-grid">
                  <article className="summary-card">
                    ...
                    <strong>PKR {trimDecimalZeros(account.openingBalance)}</strong>
                  </article>
                  <article className="summary-card">
                    <span>Inflows</span>
                    <strong>PKR {trimDecimalZeros(account.inflowAmount)}</strong>
                  </article>
                  <article className="summary-card">
                    <span>Outflows</span>
                    <strong>PKR {trimDecimalZeros(account.outflowAmount)}</strong>
                  </article>
                  <article className="summary-card">
                    <span>Closing balance</span>
                    <strong>PKR {trimDecimalZeros(account.closingBalance)}</strong>
                  </article>
                </div>
                    ...
                    <tbody>
                      {account.movements.map((movement) => (
                        <tr key={movement.movementId}>
                          ...
                          <td>PKR {trimDecimalZeros(movement.amount)}</td>
