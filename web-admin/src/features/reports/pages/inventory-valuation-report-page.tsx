          ...
          <>
            <div className="summary-grid">
              <article className="summary-card">
                ...
                <strong>PKR {trimDecimalZeros(report.totals.sellableValue)}</strong>
              </article>
              <article className="summary-card">
                <span>Damaged value</span>
                <strong>PKR {trimDecimalZeros(report.totals.damagedValue)}</strong>
              </article>
              <article className="summary-card">
                <span>Expired value</span>
                <strong>PKR {trimDecimalZeros(report.totals.expiredValue)}</strong>
              </article>
              <article className="summary-card">
                <span>Total stock value</span>
                <strong>PKR {trimDecimalZeros(report.totals.totalValue)}</strong>
              </article>
            </div>
                ...
                <tbody>
                  {report.items.map((row) => (
                    <tr key={row.productId}>
                      ...
                      <td>PKR {trimDecimalZeros(row.sellableValue)}</td>
                      <td>PKR {trimDecimalZeros(row.damagedValue)}</td>
                      <td>PKR {trimDecimalZeros(row.expiredValue)}</td>
                      <td>PKR {trimDecimalZeros(row.totalValue)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
