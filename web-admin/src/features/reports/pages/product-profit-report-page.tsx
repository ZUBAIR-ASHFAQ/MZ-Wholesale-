                ...
                <tbody>
                  {report.items.map((row) => (
                    <tr key={row.productId}>
                      ...
                      <td>{formatQuantity(row.soldBaseQuantity)}</td>
                      <td>{formatQuantity(row.returnedBaseQuantity)}</td>
                      <td>{formatQuantity(row.netBaseQuantity)}</td>
                      <td>PKR {trimDecimalZeros(row.salesAmount)}</td>
                      <td>PKR {trimDecimalZeros(row.returnAmount)}</td>
                      <td>PKR {trimDecimalZeros(row.netSalesAmount)}</td>
                      <td>PKR {trimDecimalZeros(row.costOfGoodsSoldAmount)}</td>
                      <td>PKR {trimDecimalZeros(row.returnedCostAmount)}</td>
                      <td>PKR {trimDecimalZeros(row.netCostAmount)}</td>
                      <td>PKR {trimDecimalZeros(row.estimatedProfitAmount)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
