...
function createDefaultValues(customer?: Customer): CustomerFormValues {
  return {
    ...
    creditLimit: trimDecimalZeros(customer?.creditLimit ?? "0"),
    openingBalance: "0",
      ...
      <div className="customer-form-grid">
        ...
        {!isEditing ? (
          <label className="ui-field">
            ...
            <small className="field-help">Enter the customer's existing due, up to the credit limit, or leave 0 for a new customer.</small>
