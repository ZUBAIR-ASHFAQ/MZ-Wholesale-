    ...
    <section className="sale-invoice-page">
      ...
      <section className="management-card">
        <dl className="detail-list">
          ...
          <div><dt>Total</dt><dd>PKR {trimDecimalZeros(salesReturn.totalAmount)}</dd></div>
          <div>
            <dt>Cash account</dt>
            ...
            <tbody>
              {detail.items.map((item) => (
                <tr key={item.id}>
                  ...
                  <td>PKR {trimDecimalZeros(item.unitPriceSnapshot)}</td>
      ...
      <section className="management-card">
        ...
        <dl className="detail-list">
          ...
          <div><dt>Settlement amount</dt><dd>PKR {trimDecimalZeros(detail.settlementResult.totalAmount)}</dd></div>
        </dl>
      </section>
              ...
              {detail.stockResult.map((result, index) => {
                ...
                return (
                  <tr key={`${result.productId}-${result.stockCondition}-${index}`}>
                    ...
                    <td>{formatQuantity(result.baseQuantity)}</td>
                    <td>Stock in</td>
                  </tr>
                );
              })}
