  ...
  return (
    <form className="management-form" onSubmit={handleSubmit}>
      ...
      <section className="management-card receipt-form-section">
              ...
              <tbody>
                {invoices.map((invoice) => (
                  <tr key={invoice.id}>
                    ...
                    <td>PKR {trimDecimalZeros(invoice.dueAmount)}</td>
                    <td>
              ...
              <table className="ui-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>PKR {trimDecimalZeros(availableCustomerDueAmount)}</td>
                    <td>
                      <label className="ui-field compact-money-field">
        ...
        <p className="payment-split-total"><strong>Invoice allocation total:</strong> PKR {trimDecimalZeros(allocationTotal)}</p>
        <p className="payment-split-total"><strong>Total receipt:</strong> PKR {trimDecimalZeros(receiptTotal)}</p>
      ...
      <section className="management-card receipt-form-section">
        ...
        <p className="receipt-total-check">
          Receipt total: <strong>PKR {trimDecimalZeros(receiptTotal)}</strong> · Split total: <strong>PKR {trimDecimalZeros(splitTotal)}</strong>
        </p>
      </section>
