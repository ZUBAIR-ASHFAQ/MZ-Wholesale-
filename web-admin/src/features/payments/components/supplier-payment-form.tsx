  ...
  return (
    <form className="management-form supplier-payment-form" onSubmit={handleSubmit}>
      ...
      <section className="management-card receipt-form-section">
              ...
              <tbody>
                {purchases.map((purchase) => (
                  <tr key={purchase.id}>
                    ...
                    <td>PKR {trimDecimalZeros(purchase.dueAmount)}</td>
                    <td>
              ...
              <table className="ui-table supplier-payment-payable-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>PKR {trimDecimalZeros(availableSupplierPayableAmount)}</td>
                    <td>
                      <label className="ui-field compact-money-field">
        ...
        <p className="form-summary">Purchase allocation total: PKR {trimDecimalZeros(allocationTotal)}</p>
        <p className="form-summary">Total payment: PKR {trimDecimalZeros(paymentTotal)}</p>
      </section>
      ...
      <section className="management-card receipt-form-section">
        ...
        <p className="form-summary">Payment total: PKR {trimDecimalZeros(paymentTotal)} · Split total: PKR {trimDecimalZeros(splitTotal)}</p>
      </section>
