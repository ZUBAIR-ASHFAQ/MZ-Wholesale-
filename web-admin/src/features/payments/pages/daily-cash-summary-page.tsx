        ...
        {summary ? (
          <>
            <div className="summary-grid">
              <article className="summary-card"><span>Opening</span><strong>PKR {trimDecimalZeros(summary.opening)}</strong></article>
              <article className="summary-card"><span>Inflows</span><strong>PKR {trimDecimalZeros(summary.inflows)}</strong></article>
              <article className="summary-card"><span>Outflows</span><strong>PKR {trimDecimalZeros(summary.outflows)}</strong></article>
              <article className="summary-card"><span>Expected closing</span><strong>PKR {trimDecimalZeros(summary.expectedClosing)}</strong></article>
            </div>
            ...
            <div className="management-card">
              ...
              {summary.countedAmount !== null && summary.difference !== null ? (
                <div className="summary-grid">
                  <article className="summary-card"><span>Counted amount</span><strong>PKR {trimDecimalZeros(summary.countedAmount)}</strong></article>
                  <article className="summary-card"><span>Difference</span><strong>PKR {trimDecimalZeros(summary.difference)}</strong></article>
                </div>
              ) : (
