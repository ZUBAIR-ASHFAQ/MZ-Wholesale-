...
function createInitialUnits(product?: ProductDetail): UnitRow[] {
  ...
  return product.units
    ...
    .map((unit) => ({
      ...
      conversionToBase: trimDecimalZeros(unit.conversionToBase),
...
export function ProductForm({
  ...
  const [reorderLevel, setReorderLevel] = useState(
    product?.reorderLevel ? trimDecimalZeros(product.reorderLevel) : "",
  );
  const [referencePurchasePrice, setReferencePurchasePrice] = useState(
    product?.referencePurchasePrice ? trimDecimalZeros(product.referencePurchasePrice) : "",
  );
  const [referenceSalePrice, setReferenceSalePrice] = useState(
    product?.referenceSalePrice ? trimDecimalZeros(product.referenceSalePrice) : "",
  );
