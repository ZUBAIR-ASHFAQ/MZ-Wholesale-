              ...
              <tbody>
                {result.items.map((advance) => (
                  <tr key={advance.id}>
                    ...
                    <td>PKR {trimDecimalZeros(advance.originalAmount)}</td>
                    <td>PKR {trimDecimalZeros(advance.recoveredAmount)}</td>
                    <td><strong>PKR {trimDecimalZeros(advance.outstandingAmount)}</strong></td>
